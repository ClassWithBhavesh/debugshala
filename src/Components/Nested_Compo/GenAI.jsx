...
function GenAI() {
  return (
    ...
    <link
      ...
      type="image/x-icon"
    />
    <title>Gen AI Course - Debugshala</title>
            ...
            <div className="frame-parent">
              <div className="if-statement-parent">
                ...
                <div className="while-loop" data-aos="fade-up">
                  <b className="unleash-your">Transition Into </b>
                  <b className="creativity-master">An AI Engineer </b>
                  <b className="generative-ai-and"> In Just 4 Months </b>
                  {/* <b class="shape-the-future">Shape the Future</b> */}
                </div>
                <div className="switch-case" data-aos="fade-up">
                  <div className="generative-ai-is">
                    This course is ideal for graduates, AI enthusiasts, business
                    professionals, students, programming enthusiasts, engineers,
                    freelancers, career changers, project managers, developers,
                    and anyone interested in learning about Generative AI.
                  </div>
                </div>
                <button
                  id="openModalBtn"
            ...
            <div className="div-div-block-385" data-aos="flip-left">
              ...
              <div className="div-div-block-385-inner">
                <div className="craft-code-write-headlines-d-parent">
                  <div className="craft-code-write">
                    In today's tech-driven landscape, Generative AI stands as a
                    cornerstone for innovation.
                  </div>
                  <div className="ai-program-solve">
                    Join the ranks of skilled Generative AI Experts to build
              ...
              <div className="div-div-block-390">
                ...
                <div className="div-w-node-2485c1d2-e985-173">
                  ...
                  />
                  <div className="div2">
                    <div className="in-demand-skill-in">Average CTC of 8 LPA</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            >
              ...
              >
                <div className="who-should-choose">
                  Who should choose to master Generative AI?
                </div>
              </div>
                ...
                <div className="star-shape">
                  ...
                  <div className="div-div-block-257">
                    ...
                    <div className="web-developer-wrapper">
                      <div className="web-developer">AI Enthusiasts</div>
                    </div>
                  </div>
                </div>
                ...
                <div className="star-shape2">
                  ...
                  <div className="div-div-block-2574">
                    ...
                    <div className="engineer-wrapper">
                      <div className="engineer">ML Engineer</div>
                    </div>
                  </div>
                </div>
                <div className="star-shape3">
                  ...
                  <button className="div-div-block-2576">
                    ...
                    <div className="entrepreneurs-business-leade-wrapper">
                      <div className="entrepreneurs-business">Career Changer</div>
                    </div>
                  </button>
                </div>
                  ...
                  <div className="div-div-block-2579">
                    ...
                    <div className="people-who-are-interested-to-l-parent">
                      <div className="people-who-are">
                        People who are interested to learn about Generative AI
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="frame-parent2">
                ...
                >
                  ...
                  <div className="offering-hands-on-implementati">
                    DebugShala goes beyond, offering hands-on implementation, AI
                    tools, and a performance tracking and practical learning.
                  </div>
                </div>
                  ...
                  <div className="iteration-loop">
                    ...
                    <div className="error-handler">
                      <div className="navigate-your-data">
                        Use of AI technologies and tools to enhance learning,
            ...
            <div className="function-caller">
              <div className="value-receiver">
                <div className="lets-have-an" data-aos="fade-up">
                  The Complete Gen AI Course Overview
                </div>
              </div>
              <div className="output-requester">
                        ...
                        <div className="list-w-node-2b6923aa-a6bd-85">
                          <div className="item-list-item-7">
                            <div className="overview-of-generative">
                              Understanding the concept of generative AI and its
                              significance
                            </div>
                            <img
                          ...
                          <div className="item-list-item-71">
                            <div className="generative-ai-vs">
                              &nbsp;Comparing generative AI with discriminative
                              models
                            </div>
                            <img
                          ...
                          <div className="item-list-item-72">
                            <div className="generative-ai-in">
                              Exploring recent advancements and research in
                              generative AI
                            </div>
                            <img
                          ...
                          <div className="item-list-item-73">
                            <div className="generative-ai-vs1">
                              &nbsp;End-to-end project lifecycle for generative AI
                            </div>
                            <img
                        ...
                        <div className="list-list-8">
                          <div className="item-list-item-74">
                            <div className="introduction-to-python class">
                              Basic text preprocessing techniques such as
                              tokenization,
                            </div>
                            <img
                    ...
                    <div className="advanced-applications-ethics-parent">
                      ...
                      <div className="list-w-node-3597bbb2-2995-8b-wrapper">
                        <div className="list-w-node-3597bbb2-2995-8b">
                          <div className="item-list-item-711">
                            <div className="advanced-nlp-large">
                              Building generative models with large language
                              models
                            </div>
                            <img
                              className="marker-icon11"
                          ...
                          <div className="item-list-item-712">
                            <div className="deployment-and-hardware">
                              Case studies of large language model-powered
                              applications
                            </div>
                            <img
                              className="marker-icon12"
                          ...
                          <div className="item-list-item-713">
                            <div className="introduction-to-pytorch">
                              Integration of large language models into existing
                              systems
                            </div>
                            <img
                              className="marker-icon13"
                ...
                <div className="div-hero-mentor-component4" data-aos="flip-up">
                  <div className="div-hero-mentor-details-container">
                    <div className="div-hero-mentor-details4">
                      <b className="advanced-applications-and">
                        Guide to OpenAI and its Ready-to-Use Models with
                        Applications
                      </b>
                    </div>
                    <button className="div-hero-mentor-info-highligh4">
                      <div className="module-4">module 6</div>
                    </button>
                  </div>
                  <div className="div-hero-mentor-component-inner1">
                    <div className="advanced-applications-ethics-parent">
                      ...
                      <div className="list-w-node-3597bbb2-2995-8b-wrapper">
                        <div className="list-w-node-3597bbb2-2995-8b">
                          ...
                          <div className="item-list-item-712">
                            <div className="deployment-and-hardware">
                              Using pre-built models from OpenAI
                            </div>
                            <img
                              className="marker-icon12"
                              alt=""
                          ...
                          <div className="item-list-item-713">
                            <div className="introduction-to-pytorch">
                              Application development with OpenAI models
                            </div>
                            <img
                              className="marker-icon13"
                              alt=""
                ...
                <div className="div-hero-mentor-component4" data-aos="flip-up">
                  <div className="div-hero-mentor-details-container">
                    ...
                    <button className="div-hero-mentor-info-highligh4">
                      <div className="module-4">module 7</div>
                    </button>
                  </div>
                  <div className="div-hero-mentor-component-inner1">
                    <div className="advanced-applications-ethics-parent">
                ...
                <div className="div-hero-mentor-component4" data-aos="flip-up">
                  <div className="div-hero-mentor-details-container">
                    ...
                    <button className="div-hero-mentor-info-highligh4">
                      <div className="module-4">module 8</div>
                    </button>
                  </div>
                  <div className="div-hero-mentor-component-inner1">
                    <div className="advanced-applications-ethics-parent">
                      ...
                      <div className="list-w-node-3597bbb2-2995-8b-wrapper">
                        <div className="list-w-node-3597bbb2-2995-8b">
                          ...
                          <div className="item-list-item-712">
                            <div className="deployment-and-hardware">
                              Setting up a vector database with Python
                            </div>
                            <img
                              className="marker-icon12"
                              alt=""
                          ...
                          <div className="item-list-item-713">
                            <div className="introduction-to-pytorch">
                              Use cases for vector databases in large language
                              model applications
                            </div>
                            <img
                              className="marker-icon13"
                ...
                <div className="div-hero-mentor-component4" data-aos="flip-up">
                  <div className="div-hero-mentor-details-container">
                    ...
                    <button className="div-hero-mentor-info-highligh4">
                      <div className="module-4">module 9</div>
                    </button>
                  </div>
                  <div className="div-hero-mentor-component-inner1">
                    <div className="advanced-applications-ethics-parent">
                      ...
                      <div className="list-w-node-3597bbb2-2995-8b-wrapper">
                        <div className="list-w-node-3597bbb2-2995-8b">
                          ...
                          <div className="item-list-item-712">
                            <div className="deployment-and-hardware">
                              Building and deploying applications with LangChain
                            </div>
                            <img
                              className="marker-icon12"
                              alt=""
                ...
                <div className="div-hero-mentor-component4" data-aos="flip-up">
                  <div className="div-hero-mentor-details-container">
                    <div className="div-hero-mentor-details4">
                      <b className="advanced-applications-and">
                        Hands-on with LangChain (Continued)
                      </b>
                    </div>
                    <button className="div-hero-mentor-info-highligh4">
                      <div className="module-4">module 10</div>
                    </button>
                  </div>
                  <div className="div-hero-mentor-component-inner1">
                    <div className="advanced-applications-ethics-parent">
                      ...
                      <div className="list-w-node-3597bbb2-2995-8b-wrapper">
                        <div className="list-w-node-3597bbb2-2995-8b">
                          ...
                          <div className="item-list-item-712">
                            <div className="deployment-and-hardware">
                              Integrating LangChain with other tools
                            </div>
                            <img
                              className="marker-icon12"
                              alt=""
                ...
                <div className="div-hero-mentor-component4" data-aos="flip-up">
                  <div className="div-hero-mentor-details-container">
                    ...
                    <button className="div-hero-mentor-info-highligh4">
                      <div className="module-4">module 11</div>
                    </button>
                  </div>
                  <div className="div-hero-mentor-component-inner1">
                    <div className="advanced-applications-ethics-parent">
                      ...
                      <div className="list-w-node-3597bbb2-2995-8b-wrapper">
                        <div className="list-w-node-3597bbb2-2995-8b">
                          ...
                          <div className="item-list-item-712">
                            <div className="deployment-and-hardware">
                              Building large language model applications with
                              LlamaIndex
                            </div>
                            <img
                              className="marker-icon12"
                ...
                <div className="div-hero-mentor-component4" data-aos="flip-up">
                  <div className="div-hero-mentor-details-container">
                    ...
                    <button className="div-hero-mentor-info-highligh4">
                      <div className="module-4">module 12</div>
                    </button>
                  </div>
                  <div className="div-hero-mentor-component-inner1">
                    <div className="advanced-applications-ethics-parent">
                      ...
                      <div className="list-w-node-3597bbb2-2995-8b-wrapper">
                        <div className="list-w-node-3597bbb2-2995-8b">
                          ...
                          <div className="item-list-item-713">
                            <div className="introduction-to-pytorch">
                              Project showcases and examples
                            </div>
                            <img
                              className="marker-icon13"
                              alt=""
                ...
                <div className="div-hero-mentor-component4" data-aos="flip-up">
                  <div className="div-hero-mentor-details-container">
                    ...
                    <button className="div-hero-mentor-info-highligh4">
                      <div className="module-4">module 13</div>
                    </button>
                  </div>
                  <div className="div-hero-mentor-component-inner1">
                    <div className="advanced-applications-ethics-parent">
                  ...
                  <div className="frame-parent6">
                    <div className="image-wrapper4">
                      <img
                        ...
                        alt=""
                        src="/images/Logos For Courses Group/Generative AI/Python.png"
                      />
                    </div>
                  ...
                  <div className="frame-parent7">
                    <div className="image-wrapper5">
                      <img
                        ...
                        alt=""
                        src="/images/Logos For Courses Group/Generative AI/Jupyter.png"
                      />
                    </div>
                  ...
                  <div className="frame-parent8">
                    <div className="image-wrapper6">
                      <img
                        ...
                        alt=""
                        src="/images/Logos For Courses Group/Generative AI/TensorFlow.png"
                      />
                    </div>
                    ...
                    <div className="frame-parent10">
                      <div className="image-wrapper7">
                        <img
                          ...
                          alt=""
                          src="/images/Logos For Courses Group/Generative AI/PyTorch.png"
                        />
                      </div>
                    ...
                    <div className="frame-parent11">
                      <div className="image-wrapper8">
                        <img
                          ...
                          alt=""
                          src="/images/Logos For Courses Group/Generative AI/NLTK.png"
                        />
                      </div>
                  ...
                  <div className="frame-parent12">
                    <div className="frame-parent13">
                      <div className="image-parent2">
                        <img
                          ...
                          alt=""
                          src="/images/Logos For Courses Group/Generative AI/BERT.png"
                        />
                        {/* <img
                      class="image-icon20"
                      alt=""
                    ...
                    <div className="frame-parent14">
                      <div className="image-parent3">
                        <img
                          ...
                          alt=""
                          src="/images/Logos For Courses Group/Generative AI/Sapcy.png"
                        />
                        {/* <img
                      class="image-icon22"
                      alt=""
                    ...
                    /> */}
                        <img
                          ...
                          alt=""
                          src="/images/Logos For Courses Group/Generative AI/Hugging_face_transformer.png"
                        />
                      </div>
                    ...
                    <div className="accordion" id="accordionExample">
                      <div className="accordion-item">
                        <h2 className="accordion-header">
                          ...
                          >
                            What makes Debugshala's Generative AI course in Indore
                            unique?
                          </button>
                        </h2>
                        <div
                        ...
                        >
                          <div className="accordion-body">
                            Debugshala's Generative AI course in Indore is unique
                            because it offers practical offline learning,
                            personalized training experience, and 100% placement
                            assistance. The course also provides access to free
                            developer toolkits and resources, and students can
                            benefit from an interactive developer community.
                          </div>
                        </div>
                      </div>
                      <div className="accordion-item">
                        <h2 className="accordion-header">
                          <button
                            ...
                            style={{ color: "rgb(214, 210, 210)" }}
                          >
                            Can you provide more details about Debugshala's
                            Generative AI courses in Indore?
                          </button>
                        </h2>
                        <div
                          id="collapseTwo"
                        ...
                        >
                          <div className="accordion-body">
                            Debugshala's Generative AI course in Indore covers a
                            wide range of topics related to AI and machine
                            learning, including text preprocessing, word
                            embedding, large language models, and generative AI
                            algorithms. The course also covers tools such as
                            Hugging Face, OpenAI, and LangChain, and students will
                            learn how to use these tools to build their own AI
                            applications.
                          </div>
                        </div>
                      </div>
                      <div className="accordion-item">
                        <h2 className="accordion-header">
                          <button
                            ...
                            style={{ color: "rgb(214, 210, 210)" }}
                          >
                            What is the fee structure for Debugshala's Generative
                            AI program in Indore?
                          </button>
                        </h2>
                        <div
                          id="collapseThree"
                        ...
                        >
                          <div className="accordion-body">
                            The fee structure for Debugshala's Generative AI
                            program in Indore may vary depending on the duration
                            and format of the course. We recommend contacting
                            Debugshala's admission team for the latest and most
                      ...
                      <div className="accordion-item">
                        <h2 className="accordion-header">
                          <button
                            ...
                            style={{ color: "rgb(214, 210, 210)" }}
                          >
                            How does Debugshala's Generative AI course ensure
                            student mastery in AI and Machine Learning?
                          </button>
                        </h2>
                        <div
                          id="collapseFour"
                        ...
                        >
                          <div className="accordion-body">
                            Debugshala's Generative AI course ensures student
                            mastery in AI and Machine Learning by providing
                      ...
                      <div className="accordion-item">
                        ...
                        >
                          <div className="accordion-body">
                            ...
                            in the AI and machine learning field. The placement
                      ...
                      <div className="accordion-item">
                        ...
                        >
                          <div className="accordion-body">
                            ...
                            secure job opportunities in the AI and machine
                            learning field. Debugshala also has partnerships with
                            several companies that offer job opportunities to its
                            students.
                          </div>
                        </div>
                      </div>
