...
function DataScience() {
  ...
  <link
    ...
    type="image/x-icon"
  />
  <title>Data Science Course - Debugshala</title>
            ...
            <div className="if-statement-parent">
              ...
              <div className="switch-case" data-aos="fade-up">
                <div className="generative-ai-is">
                  This course is perfect for graduates, data enthusiasts,
                  business analysts, students, programming enthusiasts,
                  engineers, freelancers, career changers, project managers,
                  developers, and anyone interested in learning about Data
                  Science.
                </div>
              </div>
              <button
          ...
          <div className="div-div-block-385" data-aos="flip-left">
            <div className="why-choose-generative-ai-progr-wrapper">
              <div className="why-choose-generative">
                Why choose to Master Data Science?
              </div>
            </div>
            <div className="div-div-block-385-inner">
              <div className="craft-code-write-headlines-d-parent">
                <div className="craft-code-write">
                  With the increasing need for businesses to make data-driven
                  decisions, the demand for skilled Data Science professionals
                  is on the rise. Here are some reasons why you should choose to
                  master Data Science:
                </div>
              </div>
            </div>
        ...
        <div className="image-handler">
          ...
          >
            ...
            <div className="who-sec-content">
              ...
              cornerstone for innovation. <br /> Join the ranks of skilled
              Generative AI Experts to build dynamic and scalable solutions.
            </div>
                ...
                <div className="div-div-block-2579">
                  ...
                  <div className="people-who-are-interested-to-l-parent">
                    <div className="people-who-are">
                      People who are interested to learn about Data Science
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="frame-wrapper" data-aos="fade-up">
              <div className="how-does-debugshala-navigate-t-parent">
                <div className="how-does-debugshala">
                  Why choose Debugshala's Data Science
                </div>
            ...
            <div className="frame-parent2">
              ...
              >
                <div className="choosing-a-course">
                  Debugshala's Data Science course in Indore is unique and
                  offers several benefits to its learners. Here are some reasons
                  why you should choose Debugshala's Data Science course:
                </div>
              </div>
                  ...
                  <div className="data-aggregator">
                    ...
                    <div className="logic-branch">
                      <div className="benefit-from-a">
                        Debugshala's Data Science course offers hands-on
                        training in a physical classroom setting, allowing
                        students to apply concepts to real-world projects and
                        case studies.
                      </div>
                    </div>
                  </div>
                ...
                <div className="div-animated-container-parent">
                  ...
                  <div className="benefit-from-a-carefully-curat-parent">
                    <div className="benefit-from-a1">
                      Debugshala's Data Science course provides a customized
                      curriculum and teaching methods to suit individual needs
                      and goals, ensuring maximum benefit from the training
                      program.
                    </div>
                  </div>
                </div>
                ...
                <div className="iteration-loop">
                  ...
                  <div className="error-handler">
                    <div className="navigate-your-data">
                      Debugshala's Data Science course uses AI technologies and
                      tools to enhance learning, providing a more engaging and
              ...
              <div className="frame-wrapper2">
                <div className="frame-parent5">
                  ...
                  <div className="track-your-progress">
                    Debugshala's Data Science course provides full support in
                    securing job placements after course completion, including
                    resume building, interview preparation, and job search
                    assistance.
                  </div>
                </div>
              </div>
                ...
                <div className="input-splitter">
                  ...
                  <div className="control-structure">
                    <div className="you-learn-and">
                      Debugshala's Data Science course offers a platform for
                      students to connect with other developers, ask questions,
                      and gain new insights in a collaborative environment.
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className="logic-builder">
                  <div className="div-hero-mentor-details1">
                    <b className="foundations-of-generative">
                      Python Programming, Data Basics, and Analysis
                    </b>
                  </div>
                ...
                <div className="iteration-loop-manager">
                  <div className="data-connection-network">
                    <div className="introduction-to-generative">
                      Unlocking the Power of Python, MySQL, and Data Analysis
                      ...
                      <div className="list-w-node-2b6923aa-a6bd-85">
                        ...
                        <div className="item-list-item-71">
                          <div className="generative-ai-vs">
                            &nbsp;Learn MySQL for database operations.
                          </div>
                          <img
                        ...
                        <div className="item-list-item-72">
                          <div className="generative-ai-in">
                            Acquire skills in data extraction, preprocessing,
                            and analysis using Python libraries such as Pandas
                            and NumPy.
                          </div>
                          <img
                        ...
                        <div className="item-list-item-73">
                          <div className="generative-ai-vs1">
                            &nbsp; Understand CRUD operations with SQL.
                          </div>
                          <img
                      ...
                      <div className="list-list-8">
                        ...
                        <div className="item-list-item-76">
                          <div className="introduction-to-version class">
                            Explore dynamic and interactive visualizations with
              ...
              <div className="div-hero-mentor-component3" data-aos="flip-up">
                <div className="div-hero-mentor-details-group">
                  <div className="div-hero-mentor-details3">
                    <b className="deep-dive-into">Machine Learning</b>
                  </div>
                      ...
                      <div className="list-list-81">
                        <div className="item-list-item-77">
                          <div className="introduction-to-deep">
                            Grasp machine learning concepts and types.
                          </div>
                          <img
                        ...
                        <div className="item-list-item-79">
                          <div className="variational-autoencoders-vaes">
                            Optimize models through feature engineering and
                            selection.
                          </div>
                          <img
                        ...
                        <div className="item-list-item-710">
                          <div className="transformer-models">
                            Introduce neural networks using TensorFlow and
                            Keras.
                          </div>
                          <img
                        ...
                        <div className="item-list-item-710">
                          <div className="transformer-models">
                            Build and fine-tune predictive models using machine
                            learning techniques.
                          </div>
                          <img
                            className="marker-icon10"
                ...
                <div className="div-hero-mentor-details-container">
                  <div className="div-hero-mentor-details4">
                    <b className="advanced-applications-and">
                      Advanced Topics and Real-world Applications in Data
                      Science
                    </b>
                  </div>
                      ...
                      <div className="list-w-node-3597bbb2-2995-8b">
                        <div className="item-list-item-711">
                          <div className="advanced-nlp-large">
                            Dive into time series analysis and forecasting.
                          </div>
                          <img
                        ...
                        <div className="item-list-item-713">
                          <div className="introduction-to-pytorch">
                            Undertake advanced data analysis and machine
                            learning projects using real-world datasets.
                          </div>
                          <img
                ...
                <div className="frame-parent6">
                  <div className="image-wrapper4">
                    <img
                      ...
                      alt=""
                      src="/images/Logos For Courses Group/Data Science/Python.png"
                    />
                  </div>
                ...
                <div className="frame-parent7">
                  <div className="image-wrapper5">
                    <img
                      ...
                      alt=""
                      src="/images/Logos For Courses Group/Data Science/NumPy.png"
                    />
                  </div>
                ...
                <div className="frame-parent8">
                  <div className="image-wrapper6">
                    <img
                      ...
                      alt=""
                      src="/images/Logos For Courses Group/Data Science/Pandas.png"
                    />
                  </div>
                ...
                <div className="frame-parent9">
                  <div className="image-parent1">
                    <img
                      ...
                      alt=""
                      src="/images/Logos For Courses Group/Data Science/MatPlotlib.png"
                    />
                    <div className="git-wrapper">
                      <div className="git">MetplotLib</div>
                    </div>
                  </div>
                  <div className="frame-parent10">
                    <div className="image-wrapper7">
                      <img
                        ...
                        alt=""
                        src="/images/Logos For Courses Group/Data Science/SeaBorn.png"
                      />
                    </div>
                    <div className="pytorch">SeaBourn</div>
                  </div>
                ...
                <div className="frame-parent12">
                  <div className="frame-parent13">
                    <div className="image-parent2">
                      <img
                        ...
                        alt=""
                        src="/images/Logos For Courses Group/Data Science/SciPy.png"
                      />
                      {/* <img
                    class="image-icon20"
                    alt=""
                  ...
                  <div className="frame-parent14">
                    <div className="image-parent3">
                      <img
                        ...
                        alt=""
                        src="/images/Logos For Courses Group/Data Science/TensorFlow.png"
                      />
                      {/* <img
                    class="image-icon22"
                    alt=""
                  ...
                  /> */}
                    ...
                    <div className="spacy-parent">
                      <div className="spacy">TensorFlow</div>
                  ...
                  /> */}
                      <img
                        ...
                        alt=""
                        src="/images/Logos For Courses Group/Data Science/PyTorch.png"
                      />
                    </div>
                    <div className="hugging-face-transformers-parent">
                      <div className="hugging-face-transformers">PyTroch</div>
                    </div>
                  </div>
                </div>
              </div>
