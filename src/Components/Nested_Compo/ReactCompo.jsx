...
function ReactCompo() {
  return (
    ...
    <link rel="stylesheet" href="./assets/CSS/style.css11" />
    <link
      rel="stylesheet"
    ...
    <link
      ...
      type="image/x-icon"
    />
    <title>React.js Course - Debugshala</title>
              ...
              <div className="if-statement-parent">
                ...
                <div className="while-loop" data-aos="fade-up">
                  <b className="unleash-your">
                    Become a Professional React Developer in just 4 months
                  </b>
                </div>
                <div className="switch-case" data-aos="fade-up">
                  <div className="generative-ai-is">
                    The demand for skilled React Developers is soaring as
                    businesses seek to enhance user interfaces and build scalable
                    web applications. Mastering React Development can lead to a
                    rewarding career with abundant job opportunities.
                  </div>
                </div>
                <button
                  id="openModalBtn"
            ...
            <div className="div-div-block-385" data-aos="flip-left">
              <div className="why-choose-generative-ai-progr-wrapper">
                <div className="why-choose-generative">
                  Why choose to Master React Development?
                </div>
              </div>
              <div className="div-div-block-385-inner">
                <div className="craft-code-write-headlines-d-parent">
                  <div className="craft-code-write">
                    React is extensively used across industries for its efficient
                    UI development capabilities, making it a highly sought-after
                    skill. Here are some reasons why you should choose to master
                    React Development:
                  </div>
                </div>
              </div>
              <div className="div-div-block-390">
                ...
                <div className="div-w-node-ecbd7dfc-0325-65e5">
                  ...
                  <div className="solve-real-world-problems">
                    #1 skill for front-end development
                  </div>
                </div>
            ...
            >
              ...
              >
                <div className="who-should-choose">
                  Who should choose to master React Development?
                </div>
              </div>
              <div style={{ fontSize: "1.5rem" }}>
                In today's digital age, React Development is essential for
                creating dynamic and responsive web applications. Join the ranks
                of skilled React Developers to innovate and excel in:
              </div>
                ...
                <div className="star-shape1">
                  ...
                  <div className="div-div-block-2572">
                    ...
                    <div className="students-wrapper">
                      <div className="students">Students and Academics</div>
                    </div>
                  </div>
                </div>
                ...
                <div className="star-shape3">
                  <div className="div-div-block-2575">
                    ...
                    <div className="data-scientists-analysts-wrapper">
                      <div className="data-scientists">UX/UI Designers</div>
                    </div>
                  </div>
              ...
              <div class="div-div-block-257-parent">
                <div class="div-div-block-2577">
                  <img
                    class="div-w-node-51f29905-2f32-e2b-icon"
                    alt=""
                    src="/images/extra__icons/tick_ka_nissan.png"
                  />
  
                  <div class="content-creators-writers-wrapper">
                    <div class="content-creators">
                      Content Creators & Writers
                    </div>
                  </div>
                </div>
                <div class="div-div-block-2578">
                  <img
                    class="div-w-node-fd4a7b4c-838a-0f24-icon"
                    alt=""
                    src="/images/extra__icons/tick_ka_nissan.png"
                  />
              ...
              <div class="div-div-block-2579">
                <div class="div-w-node-1fd9a149-eac6-bda-wrapper">
                  <img
                    class="div-w-node-1fd9a149-eac6-bda-icon"
                    alt=""
                    src="/images/extra__icons/tick_ka_nissan.png"
                  />
                </div>
                <div class="people-who-are-interested-to-l-parent">
                  <div class="people-who-are">
                    People who are interested to learn about
                  </div>
                  <div class="ai-and-curious">AI and curious about AI</div>
                </div>
              </div>
            </div> */}
              </div>
              ...
              <div className="frame-wrapper" data-aos="fade-up">
                <div className="how-does-debugshala-navigate-t-parent">
                  <div className="how-does-debugshala">
                    Why choose Debugshala's React Development course in Indore?
                  </div>
                </div>
              </div>
              <div className="frame-parent2">
                ...
                >
                  <div className="choosing-a-course">
                    Debugshala's React Development course in Indore offers unique
                    advantages tailored for aspiring developers:
                  </div>
                </div>
                    ...
                    <div className="data-aggregator">
                      ...
                      <div className="logic-branch">
                        <div className="benefit-from-a">
                          Hands-on training in a physical classroom with
                          real-world projects.
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="div-animated-container-parent">
                    ...
                    <div className="benefit-from-a-carefully-curat-parent">
                      <div className="benefit-from-a1">
                        Customized curriculum to meet individual learning goals.
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="iteration-loop">
                    <div className="div-animated-container2">
                      <div className="personal-ai-assistant">
                        AI-driven Training Methods
                      </div>
                    </div>
                    <div className="error-handler">
                      <div className="navigate-your-data">
                        Utilization of AI technologies for enhanced learning
                        experiences.
                      </div>
                    </div>
                  </div>
                ...
                <div className="frame-wrapper2">
                  <div className="frame-parent5">
                    ...
                    <div className="track-your-progress">
                      Comprehensive support for job placements, including resume
                  ...
                  <div className="input-splitter">
                    ...
                    <div className="control-structure">
                      <div className="you-learn-and">
                        Collaborative platform to connect with peers and gain
                        insights.
                      </div>
                    </div>
                  </div>
            ...
            <div className="function-caller">
              <div className="value-receiver">
                <div className="lets-have-an" data-aos="fade-up">
                  React Development Course Overview:
                </div>
              </div>
              <div className="output-requester">
                        ...
                        <div className="list-w-node-2b6923aa-a6bd-85">
                          ...
                          <div className="item-list-item-73">
                            <div className="generative-ai-vs1">
                              &nbsp;Project: Building a static webpage with
                    ...
                    <div className="introduction-to-programming-an-parent">
                      ...
                      <div className="list-list-8-wrapper">
                        <div className="list-list-8">
                          ...
                          <div className="item-list-item-76">
                            <div className="introduction-to-version class">
                              Project: Creating a simple React application with
                  ...
                  <div className="div-hero-mentor-component-child">
                    <div className="deep-dive-into-generative-mode-parent">
                      <div className="deep-dive-into1">
                        React Router Basics: Setting up routing in a single-page
                        application
                      </div>
                        ...
                        <div className="list-list-81">
                          ...
                          <div className="item-list-item-79">
                            <div className="variational-autoencoders-vaes">
                              Project: Implementing navigation and multiple
                              views/pages in a React application
                            </div>
                            <img
                          ...
                          {/* <div class="item-list-item-710">
                        <div class="transformer-models">
                          Transformer Models
                        </div>
                        <img
                          class="marker-icon10"
                  ...
                  <div className="div-hero-mentor-details-container">
                    <div className="div-hero-mentor-details4">
                      <b className="advanced-applications-and">
                        State Management and Advanced React
                      </b>
                    </div>
                  ...
                  <div className="div-hero-mentor-component-inner1">
                    <div className="advanced-applications-ethics-parent">
                      <div className="advanced-applications-ethics">
                        Introduction to Redux: State management principles
                      </div>
                        ...
                        <div className="list-w-node-3597bbb2-2995-8b">
                          ...
                          <div className="item-list-item-713">
                            <div className="introduction-to-pytorch">
                              Advanced React Concepts: Context API, Higher-Order
                              Components (HOCs), Render Props
                            </div>
                            <img
                          ...
                          <div className="item-list-item-714">
                            <div className="finetuning-large-language">
                              Project: Implementing global state management and
                              advanced features in a React project
                            </div>
                            <img
                          ...
                          {/* <div class="item-list-item-715">
                        <div class="final-project-building">
                ...
                <div className="div-hero-mentor-component4" data-aos="flip-up">
                  ...
                  <div className="div-hero-mentor-component-inner1">
                    <div className="advanced-applications-ethics-parent">
                      <div className="advanced-applications-ethics">
                        Testing React Applications: Unit testing with Jest and
                        Enzyme
                      </div>
                      <div className="list-w-node-3597bbb2-2995-8b-wrapper">
                        <div className="list-w-node-3597bbb2-2995-8b">
                          {/* <div class="item-list-item-711">
                        <div class="advanced-nlp-large">
                          Mocking APIs and Asynchronous Testing
                        </div>
                        <img
                          class="marker-icon11"
                          alt=""
                        ...
                        />
                          ...
                          <div className="item-list-item-712">
                            <div className="deployment-and-hardware">
                              Performance Optimization Techniques: Memoization,
                          ...
                          <div className="item-list-item-713">
                            <div className="introduction-to-pytorch">
                              Deployment Strategies: Creating optimized builds and
                          ...
                          <div className="item-list-item-714">
                            <div className="finetuning-large-language">
                              Project: Writing tests, optimizing performance, and
                  ...
                  <div className="frame-parent6">
                    <div className="image-wrapper4">
                      <img
                        ...
                        alt=""
                        src="/images/Logos For Courses Group/React/HTML.png"
                      />
                    </div>
                  ...
                  <div className="frame-parent7">
                    <div className="image-wrapper5">
                      <img
                        ...
                        alt=""
                        src="/images/Logos For Courses Group/React/CSS.png"
                      />
                    </div>
                  ...
                  <div className="frame-parent8">
                    <div className="image-wrapper6">
                      <img
                        ...
                        alt=""
                        src="/images/Logos For Courses Group/React/JS.png"
                      />
                    </div>
                  ...
                  <div className="frame-parent9">
                    <div className="image-parent1">
                      <img
                        ...
                        alt=""
                        src="/images/Logos For Courses Group/Next JS/TailwindCSS.png"
                      />
                      <div className="git-wrapper">
                        <div className="git">Tailwind CSS</div>
                      </div>
                    </div>
                    <div className="frame-parent10">
                      <div className="image-wrapper7">
                        <img
                          ...
                          alt=""
                          src="/images/Logos For Courses Group/Next JS/React.png"
                        />
                      </div>
                      <div className="pytorch">ReactJS</div>
                    </div>
                    <div className="frame-parent11">
                      <div className="image-wrapper8">
                        <img
                          ...
                          alt=""
                          src="/images/Logos For Courses Group/Next JS/RadixUI.png"
                        />
                      </div>
                      <div className="nltk">Radix UI</div>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="frame-parent12">
                    ...
                    <div className="frame-parent14">
                      <div className="image-parent3">
                        <img
                          ...
                          alt=""
                          src="/images/Logos For Courses Group/React/Redux.png"
                        />
                        {/* <img
                      class="image-icon22"
                      alt=""
                    ...
                    /> */}
                        <img
                          ...
                          alt=""
                          src="/images/Logos For Courses Group/React/Vercel.png"
                        />
                      </div>
                  ...
                  <div className="frame-wrapper3" data-aos="fade-right">
                    <div className="frame-parent19">
                      ...
                      <div className="seek-guidance-and">
                        Understand career aspirations and choose the right course.
                      </div>
                    </div>
                  </div>
                  <div className="frame-parent20" data-aos="fade-right">
                    <div className="frame-parent21">
                      ...
                      <div className="enhance-employability-skills">
                        Prepare for job placements with resume building and
                        interview skills.
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="frame-parent22" data-aos="fade-right">
                      <div className="data-aggregator-parent">
                        ...
                        <div className="engage-in-mock">
                          Gain exposure to interviews and job opportunities in
                          React Development.
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="icon-generator">
                    <div className="layout-organizer" data-aos="fade-left">
                      ...
                      <div className="gain-practical-experience">
                        Complete formalities and enroll in the React Development
                        program
                      </div>
                    </div>
                    ...
                    <div className="conditional-handler" data-aos="fade-left">
                      ...
                      <div className="timer-controller">
                        <div className="secure-a-job">
                          Secure job placement with Debugshala's 100% placement
                          assistance
                        </div>
                      </div>
                    </div>
                      ...
                      <div className="accordion-item">
                        <h2 className="accordion-header">
                          <button
                            ...
                            style={{ color: "rgb(214, 210, 210)" }}
                          >
                            How wil lthis program help me prepare for a career in
                            generative AI?
                          </button>
                        </h2>
                        <div
                      ...
                      <div className="accordion-item">
                        <h2 className="accordion-header">
                          <button
                            ...
                            style={{ color: "rgb(214, 210, 210)" }}
                          >
                            What are ethical considerations of using generative
                            AI?
                          </button>
                        </h2>
                        <div
