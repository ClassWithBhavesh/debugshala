...
function Next() {
  ...
  <link
    ...
    type="image/x-icon"
  />
  <title>Next.js Course - Debugshala</title>
            ...
            <div className="if-statement-parent">
              ...
              <div className="while-loop" data-aos="fade-up">
                <b className="unleash-your">
                  Become a Professional Next.js Developer in just 6 months
                </b>
              </div>
              <div className="switch-case" data-aos="fade-up">
                <div className="generative-ai-is">
                  The demand for skilled Next.js Developers is skyrocketing as
                  businesses seek fast, scalable, and SEO-friendly web
                  applications. Mastering Next.js Development can pave the way
                  to a successful career with abundant job opportunities.
                </div>
              </div>
              <button
                id="openModalBtn"
          ...
          <div className="div-div-block-385" data-aos="flip-left">
            <div className="why-choose-generative-ai-progr-wrapper">
              <div className="why-choose-generative">
                Why choose to Master Next.js Development with
                <h1 style={{ textAlign: "center" }}>Debugshala?</h1>
              </div>
            </div>
            <div className="div-div-block-385-inner">
              <div className="craft-code-write-headlines-d-parent">
                <div className="craft-code-write">
                  With the increasing adoption of Next.js in web development,
                  the demand for skilled Next.js Developers is on the rise.
                  Here's why Debugshala's Next.js Development course stands out:
                </div>
              </div>
            </div>
            <div className="div-div-block-390">
              <div className="div-w-node-3411eaf0-61c5-a1f">
                ...
                <div className="div">
                  <div className="future-proof-your-career">
                    Lucrative career prospects in web development
                  </div>
                </div>
              </div>
              <div className="div-w-node-4b22400c-2877-693">
                ...
                />
                <div className="div1">
                  <div className="global-market">Essential, demand </div>
                  <div className="requirement">technical skillset</div>
                </div>
              </div>
          ...
          >
            ...
            >
              <div className="who-should-choose">
                Who should choose to master Next.js Development at
                <h1 style={{ textAlign: "center" }}>Debugshala?</h1>
              </div>
            </div>
              ...
              <div className="star-shape2">
                ...
                <div className="div-div-block-2574">
                  ...
                  <div className="engineer-wrapper">
                    <div className="engineer">UI/UX designers</div>
                  </div>
                </div>
              </div>
              <div className="star-shape3">
                <div className="div-div-block-2575">
                  ...
                  <div className="data-scientists-analysts-wrapper">
                    <div className="data-scientists">Developers</div>
                  </div>
                </div>
            ...
            <div className="frame-wrapper" data-aos="fade-up">
              <div className="how-does-debugshala-navigate-t-parent">
                <div className="how-does-debugshala">
                  Why choose Debugshala's Next.js Development course?
                </div>
              </div>
            </div>
            <div className="frame-parent2">
              ...
              >
                <div className="choosing-a-course">
                  Debugshala's Next.js Development course offers a unique blend
                  of benefits to ensure comprehensive learning and career
                  readiness:
                </div>
              </div>
                  ...
                  <div className="data-aggregator">
                    ...
                    <div className="logic-branch">
                      <div className="benefit-from-a">
                        Engage in practical, offline training sessions where you
                        can directly apply Next.js concepts to real-world
                ...
                <div className="div-animated-container-parent">
                  ...
                  <div className="benefit-from-a-carefully-curat-parent">
                    <div className="benefit-from-a1">
                      Tailored learning paths and teaching methods designed to
                      meet your specific learning objectives, ensuring you
                      derive maximum value from the course.
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className="iteration-loop">
                  ...
                  <div className="error-handler">
                    <div className="navigate-your-data">
                      Utilization of AI technologies and tools to enrich your
                      learning experience, making it more interactive and
                      engaging.
                    </div>
                  </div>
                </div>
              ...
              <div className="frame-wrapper2">
                <div className="frame-parent5">
                  ...
                  <div className="track-your-progress">
                    Benefit from comprehensive assistance in securing job
                    placements, including resume building, interview
                ...
                <div className="input-splitter">
                  ...
                  <div className="control-structure">
                    <div className="you-learn-and">
                      Connect with a dynamic community of developers, fostering
                      collaboration, knowledge sharing, and insightful
                      discussions.
                    </div>
                  </div>
                </div>
          ...
          <div className="function-caller">
            <div className="value-receiver">
              <div className="lets-have-an" data-aos="fade-up">
                Next.js Development Course Overview
              </div>
            </div>
            <div className="output-requester">
                      ...
                      <div className="list-w-node-2b6923aa-a6bd-85">
                        ...
                        <div className="item-list-item-72">
                          <div className="generative-ai-in">
                            JavaScript basics: variables, data types, and
                            operators
                          </div>
                          <img
              ...
              <div className="div-hero-mentor-component3" data-aos="flip-up">
                <div className="div-hero-mentor-details-group">
                  <div className="div-hero-mentor-details3">
                    <b className="deep-dive-into"> Next.js Fundamentals</b>
                  </div>
                      ...
                      <div className="list-w-node-3597bbb2-2995-8b">
                        <div className="item-list-item-711">
                          <div className="advanced-nlp-large">
                            Creating and using schemas with Mongoose
                          </div>
                          <img
              ...
              <div className="div-hero-mentor-component4" data-aos="flip-up">
                ...
                <div className="div-hero-mentor-component-inner1">
                  <div className="advanced-applications-ethics-parent">
                    <div className="advanced-applications-ethics">
                      Building a full-stack web application using HTML, CSS,
                    ...
                    <div className="list-w-node-3597bbb2-2995-8b-wrapper">
                      <div className="list-w-node-3597bbb2-2995-8b">
                        ...
                        <div className="item-list-item-713">
                          <div className="introduction-to-pytorch">
                            Creating and managing data with MongoDB and Mongoose
                          </div>
                          <img
                            className="marker-icon13"
                            alt=""
            ...
            <div className="connected-components">
              <div className="feature-extractor">
                <div className="frame-parent6">
                  <div className="image-wrapper4">
                    <img
                      ...
                      alt=""
                      src="/images/Logos For Courses Group/Next JS/HTML_CSS.png"
                    />
                  </div>
                  <div className="python">HTML / CSS</div>
                </div>
                <div className="frame-parent7">
                  <div className="image-wrapper5">
                    <img
                      ...
                      alt=""
                      src="/images/Logos For Courses Group/Next JS/JS.png"
                    />
                  </div>
                  <div className="jupiter-notebooks">JavaScript</div>
                </div>
                <div className="frame-parent8">
                  ...
                  <div className="tensorflow">Tailwind CSS</div>
                </div>
              </div>
                  ...
                  <div className="frame-parent10">
                    <div className="image-wrapper7">
                      <img
                        ...
                        alt=""
                        src="/images/Logos For Courses Group/Next JS/Next.png"
                      />
                    </div>
                    <div className="pytorch">Next</div>
                  </div>
                ...
                <div className="frame-parent12">
                  <div className="frame-parent13">
                    <div className="image-parent2">
                      <img
                        ...
                        alt=""
                        src="/images/Logos For Courses Group/Next JS/MongoDB.png"
                      />
                      {/* <img
                    class="image-icon20"
                    alt=""
                  ...
                  /> */}
                    ...
                    <div className="bert-parent">
                      <div className="bert">Mongo DB</div>
                  ...
                  /> */}
                    ...
                    <div className="spacy-parent">
                      <div className="spacy">Radix UI</div>
                  ...
                  /> */}
                      <img
                        ...
                        alt=""
                        src="/images/Logos For Courses Group/Next JS/Postman.png"
                      />
                    </div>
                    <div className="hugging-face-transformers-parent">
                      <div className="hugging-face-transformers">Postman</div>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className="frame-wrapper3" data-aos="fade-right">
                  <div className="frame-parent19">
                    ...
                    <div className="seek-guidance-and">
                      Aligning career aspirations with course objectives
                    </div>
                  </div>
                </div>
                <div className="frame-parent20" data-aos="fade-right">
                  <div className="frame-parent21">
                    ...
                    <div className="enhance-employability-skills">
                      Preparing for interviews with resume building and
                      interview coaching
                    </div>
                  </div>
                </div>
                  ...
                  <div className="frame-parent22" data-aos="fade-right">
                    <div className="data-aggregator-parent">
                      ...
                      <div className="engage-in-mock">
                        Exploring job opportunities in Next.js Development
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="icon-generator">
                  <div className="layout-organizer" data-aos="fade-left">
                    ...
                    <div className="gain-practical-experience">
                      Completing enrollment and starting the learning journey
                    </div>
                  </div>
                  ...
                  <div className="conditional-handler" data-aos="fade-left">
                    ...
                    <div className="timer-controller">
                      <div className="secure-a-job">
                        Securing job placements through Debugshala's robust
                        career support
                      </div>
                    </div>
                  </div>
