  ...
  return (
    <>
      ...
      <link
        ...
        type="image/x-icon"
      />
      <title>Data Analytics Course - Debugshala</title>
              ...
              <div className="frame-parent">
                <div className="if-statement-parent">
                  ...
                  <div className="while-loop" data-aos="fade-up">
                    <b className="unleash-your">Become an</b>
                    <b className="creativity-master">Expert Data Analyst</b>
                  ...
                  <div className="switch-case" data-aos="fade-up">
                    <div className="generative-ai-is">
                      Data is the new oil, and businesses are increasingly{" "}
                    </div>
                    <div className="from-marketing-to">
                      relying on data-driven decision making.{" "}
                    </div>
                    <div className="ready-to-shape">
                      As a result, the demand for skilled Data Analytics{" "}
                    </div>
              ...
              <div className="div-div-block-385" data-aos="flip-left">
                <div className="why-choose-generative-ai-progr-wrapper">
                  <div className="why-choose-generative">
                    Why choose to Master Data Analytics?
                  </div>
                </div>
                <div className="div-div-block-385-inner">
                  <div className="craft-code-write-headlines-d-parent">
                    <div className="craft-code-write">
                      With the increasing need for businesses to make
                      data-driven decisions, the demand for skilled Data
                    </div>
                    <div className="ai-program-solve">
                      Analytics professionals is on the rise. Here are some
                      reasons why you should choose to master Data Analytics:
                    </div>
                ...
                <div className="div-div-block-390">
                  ...
                  <div className="div-w-node-4b22400c-2877-693">
                    ...
                    />
                    <div className="div1">
                      <div className="global-market">In-demand</div>
                      <div className="requirement">technical skill</div>
                    </div>
                  </div>
                  ...
                  <div className="div-w-node-2485c1d2-e985-173">
                    ...
                    <div className="div2">
                      <div className="in-demand-skill-in">
                        Average CTC of 5 LPA in Indore
                      </div>
                      {/* <div class="div3"></div> */}
                    </div>
                  </div>
              ...
              >
                ...
                >
                  <div className="who-should-choose">
                    Who should choose to master Data Analytics?
                  </div>
                  <p>
                    In today's data-driven landscape, Data Analytics stands as a
                    cornerstone for innovation. Join the ranks of skilled Data
                    Analytics Experts to build dynamic and scalable solutions.
                  </p>
                </div>
                  ...
                  <div className="star-shape">
                    ...
                    <div className="div-div-block-257">
                      ...
                      <div className="web-developer-wrapper">
                        <div className="web-developer">Data Enthusiasts</div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="star-shape2">
                    ...
                    <div className="div-div-block-2574">
                      ...
                      <div className="engineer-wrapper">
                        <div className="engineer">Data Analysts</div>
                      </div>
                    </div>
                  </div>
                ...
                <div className="frame-wrapper" data-aos="fade-up">
                  <div className="how-does-debugshala-navigate-t-parent">
                    <div className="how-does-debugshala">
                      Why choose Debugshala's Data Analytics course in Indore?
                    </div>
                ...
                <div className="frame-parent2">
                  ...
                  >
                    <div className="choosing-a-course">
                      Debugshala's Data Analytics course in Indore is unique and
                      offers several benefits to its learners.
                    </div>
                    <div className="offering-hands-on-implementati">
                      Here are some reasons why you should choose Debugshala's
                      Data Analytics course:
                    </div>
                    {/* <div class="its-not-just">
                      ...
                      <div className="data-aggregator">
                        ...
                        <div className="logic-branch">
                          <div className="benefit-from-a">
                            Debugshala's Data Analytics course offers hands-on
                            training in a physical classroom setting, allowing
                            students to apply concepts to real-world projects
                            and case studies.
                          </div>
                          <div className="enriching-learning-experience"></div>
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="div-animated-container-parent">
                      ...
                      <div className="benefit-from-a-carefully-curat-parent">
                        <div className="benefit-from-a1">
                          Debugshala's Data Analytics course provides a
                          customized curriculum and teaching methods to suit
                          individual needs and goals, ensuring maximum benefit
                          from the training program.
                        </div>
                        <div className="enriching-learning-experience1"></div>
                      </div>
                    </div>
                  </div>
                  <img
                    ...
                    <div className="iteration-loop">
                      ...
                      <div className="error-handler">
                        <div className="navigate-your-data">
                          Debugshala's Data Analytics course uses AI
                          technologies and tools to enhance learning, providing
                          a more engaging and interactive experience.
                        </div>
                        {/* <div class="debugshala">DebugShala.</div> */}
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="frame-wrapper2">
                    <div className="frame-parent5">
                      ...
                      <div className="track-your-progress">
                        Debugshala's Data Analytics course provides full support
                        in securing job placements after course completion,
                    ...
                    <div className="input-splitter">
                      ...
                      <div className="control-structure">
                        <div className="you-learn-and">
                          Debugshala's Data Analytics course offers a platform
                          for students to connect with other developers, ask
                          questions, and gain new insights in a collaborative
                          environment.
                        </div>
                    ...
                    <div className="logic-builder">
                      <div className="div-hero-mentor-details1">
                        <b className="foundations-of-generative">
                          Python Programming Mastering Python Fundamentals for
                          Data Analytics
                        </b>
                      </div>
                    ...
                    <div className="iteration-loop-manager">
                      <div className="data-connection-network">
                        <div className="introduction-to-generative">
                          {/* Python Programming Mastering Python Fundamentals for Data Analytics */}
                        </div>
                          ...
                          <div className="list-w-node-2b6923aa-a6bd-85">
                            ...
                            <div className="item-list-item-71">
                              <div className="generative-ai-vs">
                                ...
                                Learn to work with data structures such as
                            ...
                            <div className="item-list-item-72">
                              <div className="generative-ai-in">
                                ...
                                Develop skills in data manipulation using Python
                            ...
                            <div className="item-list-item-73">
                              <div className="generative-ai-vs1">
                                ...
                                Write efficient and reusable code with functions
                                and modules.
                              </div>
                              <img
                          ...
                          <div className="list-list-8">
                            ...
                            <div className="item-list-item-75">
                              <div className="introduction-to-jupyter class">
                                ...
                                Learn Structured Query Language (SQL) for
                                database operations.
                              </div>
                              <img
                            ...
                            <div className="item-list-item-76">
                              <div className="introduction-to-version class">
                                ...
                                Develop skills in creating, modifying, and
                                querying databases.
                              </div>
                              <img
                    ...
                    <div className="div-hero-mentor-details-group">
                      <div className="div-hero-mentor-details3">
                        <b className="deep-dive-into">
                          ...
                          Data Analysis Extracting Insights from Data with
                          ...
                          <div className="list-list-81">
                            <div className="item-list-item-77">
                              <div className="introduction-to-deep">
                                ...
                                Grasp data analysis concepts and techniques.
                              </div>
                              <img
                            ...
                            <div className="item-list-item-78">
                              <div className="generative-adversarial-network">
                                ...
                                Develop skills in data cleaning, transformation,
                                and preprocessing.
                              </div>
                              <img
                            ...
                            <div className="item-list-item-79">
                              <div className="variational-autoencoders-vaes">
                                ...
                                Learn to perform exploratory data analysis (EDA)
                            ...
                            <div className="item-list-item-710">
                              <div className="transformer-models">
                                {/* Transformer Models */}
                                Understand statistical analysis techniques and
                  ...
                  >
                    <div className="div-hero-mentor-details-container">
                      <div className="div-hero-mentor-details4">
                        <b className="advanced-applications-and">
                          ...
                          Data Visualization Communicating Insights through
                    ...
                    <div className="div-hero-mentor-component-inner1">
                      <div className="advanced-applications-ethics-parent">
                        ...
                        Ethics */}
                                Explore the importance of data visualization in
                                data analytics.
                              </div>
                              <img
                            ...
                            <div className="item-list-item-712">
                              <div className="deployment-and-hardware">
                                ...
                                Create static visualizations with Matplotlib and
                                Seaborn.
                              </div>
                              <img
                            ...
                            <div className="item-list-item-713">
                              <div className="introduction-to-pytorch">
                                ...
                                Develop interactive visualizations with
                                libraries such as Plotly and Bokeh.
                              </div>
                              <img
                            ...
                            <div className="item-list-item-714">
                              <div className="finetuning-large-language">
                                ...
                                Learn about data storytelling and effective
                                report creation.
                              </div>
                              <img
                        ...
                        Application */}
                                Apply data visualization techniques to present
                                insights from data analysis projects.
                              </div>
                              <img
                  ...
                  >
                    <div className="div-hero-mentor-details-container">
                      <div className="div-hero-mentor-details4">
                        <b className="advanced-applications-and">
                          {/* Advanced Applications and Ethical Considerations */}
                          Capstone Projects Applying Data Analytics Skills to
                          Real-world Problems
                        </b>
                      </div>
                      <button className="div-hero-mentor-info-highligh4">
                          ...
                          <div className="list-w-node-3597bbb2-2995-8b">
                            <div className="item-list-item-711">
                              <div className="advanced-nlp-large">
                                {/* Advanced NLP, Large Language Models (LLMs), and
                        Ethics */}
                                Work on end-to-end data analytics projects using
                                real-world datasets.
                              </div>
                              <img
                                className="marker-icon11"
                            ...
                            <div className="item-list-item-712">
                              <div className="deployment-and-hardware">
                                {/* Deployment and Hardware Considerations */}
                                Integrate skills from Python programming,
                                database management, data analysis, and data
                                visualization.
                              </div>
                              <img
                                className="marker-icon12"
                            ...
                            <div className="item-list-item-715">
                              <div className="final-project-building">
                                {/* Final Project: Building a FullStack Generative AI
                        Application */}
                                Present your capstone project to demonstrate
                                your mastery of data analytics concepts and
                                techniques.
                              </div>
                              <img
                                className="marker-icon15"
                ...
                <div className="connected-components">
                    ...
                    <div className="frame-parent6">
                      <div className="image-wrapper4">
                        <img
                          ...
                          alt=""
                          src="/images/Logos For Courses Group/Data Analytics/Python.png"
                        />
                      </div>
                    ...
                    <div className="frame-parent7">
                      <div className="image-wrapper5">
                        <img
                          ...
                          alt=""
                          src="/images/Logos For Courses Group/Data Analytics/NumPy.png"
                        />
                      </div>
                      <div className="jupiter-notebooks">NumPy</div>
                    </div>
                    <div className="frame-parent8">
                      <div className="image-wrapper6">
                        <img
                          ...
                          alt=""
                          src="/images/Logos For Courses Group/Data Analytics/Pandas.png"
                        />
                      </div>
                      <div className="tensorflow">Pandas</div>
                    </div>
                  </div>
                    ...
                    <div className="frame-parent9">
                      <div className="image-parent1">
                        <img
                          ...
                          alt=""
                          src="/images/Logos For Courses Group/Data Analytics/MatPlotlib.png"
                        />
                        <div className="git-wrapper">
                          <div className="git">Matplotlib</div>
                        </div>
                      </div>
                      <div className="frame-parent10">
                        <div className="image-wrapper7">
                          <img
                            ...
                            alt=""
                            src="/images/Logos For Courses Group/Data Analytics/SeaBorn.png"
                          />
                        </div>
                        <div className="pytorch">Seaborn</div>
                      </div>
                      <div className="frame-parent11">
                        <div className="image-wrapper8">
                          <img
                            ...
                            alt=""
                            src="/images/Logos For Courses Group/Data Analytics/Excel.png"
                          />
                        </div>
                        <div className="nltk">Excel</div>
                      </div>
                    </div>
                  </div>
                      ...
                      <div className="frame-parent13">
                        <div className="image-parent2">
                          <img
                            ...
                            alt=""
                            src="/images/Logos For Courses Group/Data Analytics/Power_BI.png"
                          />
                          {/* <img
                    class="image-icon20"
                    alt=""
                  ...
                  /> */}
                        ...
                        <div className="bert-parent">
                          <div className="bert">Power BI</div>
                      ...
                      <div className="frame-parent14">
                        <div className="image-parent3">
                          <img
                            ...
                            alt=""
                            src="/images/Logos For Courses Group/Data Science/Scikit_Learn.png"
                          />
                          {/* <img
                    class="image-icon22"
                    alt=""
                  ...
                  /> */}
                        ...
                        <div className="spacy-parent">
                          <div className="spacy">Scikit-learn</div>
                  ...
                  /> */}
                          <img
                            ...
                            alt=""
                            src="/images/Logos For Courses Group/Data Analytics/Tableau.png"
                          />
                        </div>
                    ...
                    <div className="frame-wrapper3" data-aos="fade-right">
                      <div className="frame-parent19">
                        ...
                        <div className="seek-guidance-and">
                          ...
                          Understand your career goals and choose the right
                          course.
                        </div>
                      </div>
                    </div>
                    <div className="frame-parent20" data-aos="fade-right">
                      <div className="frame-parent21">
                        ...
                        <div className="enhance-employability-skills">
                          {/* Enhance employability skills and prepare for job interviews. */}
                      ...
                      <div className="frame-parent22" data-aos="fade-right">
                        <div className="data-aggregator-parent">
                          ...
                          <div className="engage-in-mock">
                            Get exposure to interviews and job opportunities in
                    ...
                    <div className="icon-generator">
                      ...
                      <div className="label-designer" data-aos="fade-left">
                        ...
                        <div className="develop-real-world-projects">
                          {/* Develop real-world projects to demonstrate capabilities */}
                          Work on real-world projects to gain practical
                      ...
                      <div className="conditional-handler" data-aos="fade-left">
                        ...
                        <div className="timer-controller">
                          <div className="secure-a-job">
                            ...
                            Secure a job placement with Debugshala's 100%
                        ...
                        <div className="accordion-item">
                          <h2 className="accordion-header">
                            ...
                            >
                              ...
                              What makes Debugshala's Data Analytics course in
                              Indore unique?
                            </button>
                          </h2>
                          <div
                          ...
                          >
                            <div className="accordion-body">
                              ...
                              Debugshala's Data Analytics course in Indore is
                              unique because it offers practical offline
                              learning, personalized training experience,
                              AI-oriented training methods, 100% placement
                              assistance, interactive developer community, and
                              free developer toolkits and resources.
                            </div>
                          </div>
                        </div>
                        <div className="accordion-item">
                          <h2 className="accordion-header">
                            ...
                            >
                              ...
                              What is the fee structure for Debugshala's Data
                              Analytics program in Indore?
                            </button>
                          </h2>
                          <div
                            id="collapseTwo"
                          ...
                          >
                            <div className="accordion-body">
                              ...
                              The fee structure for Debugshala's Data Analytics
                              program in Indore may vary depending on the
                              duration and format of the course. Please contact
                              Debugshala's admission team for more information
                              on fees.
                            </div>
                          </div>
                        </div>
                        <div className="accordion-item">
                          <h2 className="accordion-header">
                            ...
                            >
                              ...
                              How does Debugshala's Data Analytics course ensure
                              student mastery in Data Analytics?
                            </button>
                          </h2>
                          <div
                            id="collapseThree"
                          ...
                          >
                            <div className="accordion-body">
                              ...
                              Debugshala's Data Analytics course ensures student
                              mastery in Data Analytics by providing hands-on
                              training and practical experience. The course
                              includes real-world projects that allow students
                              to apply their knowledge and skills to solve
                              complex problems. Additionally, the course is
                              taught by experienced industry professionals who
                              provide mentorship and guidance throughout the
                              program.
                            </div>
                          </div>
                        </div>
                        <div className="accordion-item">
                          <h2 className="accordion-header">
                            <button
                              ...
                              style={{ color: "rgb(214, 210, 210)" }}
                            >
                              {/* How wil lthis program help me prepare for a  career in generative AI? */}
                              What is the placement assistance like at
                              Debugshala's courses in Indore?
                            </button>
                          </h2>
                          <div
                            id="collapseFour"
                          ...
                          >
                            <div className="accordion-body">
                              ...
                              Debugshala's courses in Indore offer 100%
                              placement assistance to help students secure job
                              opportunities in the Data Analytics field. The
                        ...
                        <div className="accordion-item">
                          ...
                          >
                            <div className="accordion-body">
                              ...
                              AI-assisted training can benefit students in
                              several ways. It can provide personalized learning
                              experiences, adapt to the student's learning
                              style, and offer real-time feedback and support.
                              AI-assisted training can also help students to
                              stay motivated and engaged throughout the course.
                            </div>
                          </div>
                        </div>
                        <div className="accordion-item">
                          <h2 className="accordion-header">
                            <button
                              ...
                              style={{ color: "rgb(214, 210, 210)" }}
                            >
                              {/* What are ethical considerations of using generative AI? */}
                          ...
                          >
                            <div className="accordion-body">
                              ...
                              The interactive developer community at Debugshala
                              is a platform for students to connect,
                              collaborate, and learn from each other. The
                              community provides opportunities for networking,
                              mentorship, and collaboration on real-world
                              projects. Students can also participate in coding
                              challenges, hackathons, and other events to
                        ...
                        <div className="accordion-item">
                          ...
                          >
                            <div className="accordion-body">
                              ...
                              Debugshala does not have a direct affiliation with
                              any staffing or recruitment company. However,
                              Debugshala offers 100% placement assistance to
                              help students secure job opportunities in the Data
                              Analytics field. Debugshala also has partnerships
                              with several companies that offer job
